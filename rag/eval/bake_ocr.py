...
os.makedirs('data/ocr_bake',exist_ok=True)
PAGES=['data/pages/p21.png','data/pages/p23.png']
def run(mid,prompt,tag):
    try:
...
run("zai-org/GLM-OCR","Table Recognition:","glmocr")
run("datalab-to/chandra-ocr-2","이 페이지의 모든 텍스트와 표를 마크다운으로 변환하라. 표는 행과 열 구조를 정확히 유지하라.","chandra2")
run("PaddlePaddle/PaddleOCR-VL","OCR","paddleocr")
print("BAKE_DONE")
